    ...
    units: [
      ...
      },
      {
        ...
        upgrades: [
          ...
          { socket: "EQUIPMENT", name: "Smoke Grenade", pts: 6, effect: "SMOKE / LOB / ONE-SHOT" },
          { socket: "EQUIPMENT", name: "IFAK", pts: 12, effect: "When removed, remain at CEV 1. ONE-USE." },
          { socket: "SUPPORT", name: "Smoke Rounds", pts: 8, effect: "M320 may fire SMOKE at a target location instead of EXPL. IDF / SMOKE / RLD / ONE-SHOT. After firing, M320 reverts to standard rounds." }
        ]
      },
      {
        id: "usa_dm",
